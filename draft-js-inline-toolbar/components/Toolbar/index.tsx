...
export default class Toolbar extends React.Component<Props, State> {
  ...
  onSelectionChanged = () => {
    ...
    setTimeout(() => {
      ...
      // if the top < 0
      if (position.top < 30) {
        position.top = selectionRect.bottom + 10;
        showArrow = false;
      }

      this.setState({ position, showArrow });
    });
  };
  ...
  render() {
    ...
    const { overrideContent: OverrideContent, showArrow } = this.state;
    const childrenProps = {
      ...
      <div
        className={
          showArrow
            ...
            : theme.toolbarStyles.toolbarNoTriangle
        }
        style={this.getStyle()}
